...
inline void monitor_until_motion_lift(
    ...
    shared.eval_lift_until_grasp_lost_err = motion_spec::runtime::evaluate_greater_than_constraint(shared.gripper_pos, shared.lost_width);

    {
        const bool active = motion_spec::runtime::constraint_satisfied(shared.eval_lift_until_grasp_lost_err, shared.default_tolerance_Angle);
