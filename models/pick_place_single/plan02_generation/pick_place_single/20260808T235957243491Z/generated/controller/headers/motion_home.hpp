...
inline void update_motion_home(
    ...
    KDL::JntArrayVel q_qd_arm_solver_home(state.arm_solver_home.q, state.arm_solver_home.qd);
    {
        ...
        KDL::Frame _base_world_frame_arm_solver_home;
        mj_kdl::get_body_frame(
                robot.arm_solver_home.robot->model,
                robot.arm_solver_home.robot->data,
                "base_link",
                &_base_world_frame_arm_solver_home);
        shared.pose_cube_base = _base_world_frame_arm_solver_home.Inverse() * _body_frame_pose_cube_base;
    }
