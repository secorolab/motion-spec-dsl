...
int main(int argc, char **argv) {
    ...
    const auto robot_config = motion_spec::config::load("/home/batsy/work/ms/src/motion-spec-dsl/models/pick_place_single/robot.toml");
    bool headless = false;
    ...
    auto fsm_active_motion = [&](struct fsm_nbx *fsm) -> int {
        ...
        case pick_place_single_fsm::S_HOME: return 0;

        case pick_place_single_fsm::S_PICK_ABOVE: return 1;

        case pick_place_single_fsm::S_PICK: return 2;

        case pick_place_single_fsm::S_GRASP: return 3;

        case pick_place_single_fsm::S_LIFT: return 4;

        case pick_place_single_fsm::S_PLACE_ABOVE: return 5;

        case pick_place_single_fsm::S_PLACE: return 6;

        case pick_place_single_fsm::S_OPEN: return 7;

        case pick_place_single_fsm::S_RETREAT: return 8;

        case pick_place_single_fsm::S_RECOVER: return 9;
    ...
    auto fsm_dispatch = [&](struct fsm_nbx *fsm) {
        switch (fsm->currentStateIndex) {
        case pick_place_single_fsm::S_HOME:
        ...
        case pick_place_single_fsm::S_PICK_ABOVE:
        ...
        case pick_place_single_fsm::S_PICK:
        ...
        case pick_place_single_fsm::S_GRASP:
        ...
        case pick_place_single_fsm::S_LIFT:
        ...
        case pick_place_single_fsm::S_PLACE_ABOVE:
        ...
        case pick_place_single_fsm::S_PLACE:
        ...
        case pick_place_single_fsm::S_OPEN:
        ...
        case pick_place_single_fsm::S_RETREAT:
            step_motion_retreat(motion_retreat_state_instance, shared, robot, events);
            break;

        case pick_place_single_fsm::S_RECOVER:
    ...
    while (!motion_spec::runtime::stop_requested() && ((!headless || !steps_limited || headless_steps-- > 0))) {
        ...
        if (static_cast<int>(fsm->currentStateIndex) != _fsm_prev_state) {
            ...
            std::cerr << "[fsm] state   " << pick_place_single_fsm::STATE_URIS[fsm->currentStateIndex] << std::endl;
        ...
        if (_fsm_state_before == pick_place_single_fsm::S_START && fsm->currentStateIndex == pick_place_single_fsm::S_HOME) {
            events.record(13);
        }
