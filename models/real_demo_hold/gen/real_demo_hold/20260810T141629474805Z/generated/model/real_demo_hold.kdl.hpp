...
//
// KDL trees and chains for the kinematics of: real_demo_hold.scenex
#pragma once
    ...
    *tree = KDL::Tree("world_tree/world_body");
    ...
    if (!tree->addSegment(
          KDL::Segment("ft_tree/wrist_ft_body",
            KDL::Joint("kinova_ft_2f85/ft_on_pinch_site", KDL::Joint::None),
            KDL::Frame(KDL::Rotation::Quaternion(1.0, 0.0, 0.0, 6.123233995736766e-17), KDL::Vector(0.0, 0.0, -0.061525)),
            KDL::RigidBodyInertia(0.133396, KDL::Vector(0.0, 0.0, 0.0),
            KDL::RotationalInertia(3.224e-05, 3.224e-05, 5.558e-05, 0.0, 0.0, 0.0))),
    ...
    if (!tree->addSegment(
          KDL::Segment("gripper/g_base_mount",
            KDL::Joint("kinova_ft_2f85/gripper_on_ft", KDL::Joint::None),
            KDL::Frame(KDL::Rotation::Quaternion(0.0, 0.0, 0.0, 1.0), KDL::Vector(0.0, 0.0, 0.0435)),
...
inline bool make_chain_kinova_ft_2f85_chain(const KDL::Tree &tree, KDL::Chain *chain)
{
...
inline const std::unordered_map<std::string_view, std::string_view> kIris = {
    {"world_tree", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/world_tree"},
    {"world_tree/world_body", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/world_tree/world_body"},
    {"world_tree/table", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/world_tree/table"},
    {"world_tree/table_on_world", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/world_tree/table_on_world"},
    {"kinova/base_link", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova/base_link"},
    {"world_tree/arm_on_table", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/world_tree/arm_on_table"},
    {"kinova/shoulder_link", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova/shoulder_link"},
    {"kinova/joint_1", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova/joint_1"},
    {"kinova/half_arm_1_link", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova/half_arm_1_link"},
    {"kinova/joint_2", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova/joint_2"},
    {"kinova/half_arm_2_link", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova/half_arm_2_link"},
    {"kinova/joint_3", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova/joint_3"},
    {"kinova/forearm_link", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova/forearm_link"},
    {"kinova/joint_4", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova/joint_4"},
    {"kinova/spherical_wrist_1_link", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova/spherical_wrist_1_link"},
    {"kinova/joint_5", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova/joint_5"},
    {"kinova/spherical_wrist_2_link", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova/spherical_wrist_2_link"},
    {"kinova/joint_6", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova/joint_6"},
    {"kinova/bracelet_link", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova/bracelet_link"},
    {"kinova/joint_7", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova/joint_7"},
    {"ft_tree/wrist_ft_body", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/ft_tree/wrist_ft_body"},
    {"kinova_ft_2f85/ft_on_pinch_site", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova_ft_2f85/ft_on_pinch_site"},
    {"gripper/g_base_mount", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/gripper/g_base_mount"},
    {"kinova_ft_2f85/gripper_on_ft", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova_ft_2f85/gripper_on_ft"},
    {"gripper/g_base", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/gripper/g_base"},
    {"gripper/g_base_on_mount", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/gripper/g_base_on_mount"},
    {"gripper/g_left_driver", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/gripper/g_left_driver"},
    {"gripper/g_left_driver_joint", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/gripper/g_left_driver_joint"},
    {"gripper/g_base/g_pinch", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/gripper/g_base/g_pinch"},
    {"kinova_ft_2f85_chain", "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova_ft_2f85/chain"},
};
