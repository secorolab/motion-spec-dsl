...
struct arm_solver_hold_close_solver_state {
...
struct arm_solver_hold_open_solver_state {
    bool initialized = false;
    int num_spatial_directions = 0;
    int num_joints = 0;
    int num_segments = 0;
...
struct robot_io {
    ...
    manipulator_robot arm_solver_hold_close;
    manipulator_robot arm_solver_hold_open;
...
struct shared_data {
    double arm_solver_hold_close_q_joint_1 = 0.0;
    double arm_solver_hold_close_q_joint_2 = 0.0;
    double arm_solver_hold_close_q_joint_3 = 0.0;
    double arm_solver_hold_close_q_joint_4 = 0.0;
    double arm_solver_hold_close_q_joint_5 = 0.0;
    double arm_solver_hold_close_q_joint_6 = 0.0;
    double arm_solver_hold_close_q_joint_7 = 0.0;
    double arm_solver_hold_close_qd_joint_1 = 0.0;
    double arm_solver_hold_close_qd_joint_2 = 0.0;
    double arm_solver_hold_close_qd_joint_3 = 0.0;
    double arm_solver_hold_close_qd_joint_4 = 0.0;
    double arm_solver_hold_close_qd_joint_5 = 0.0;
    double arm_solver_hold_close_qd_joint_6 = 0.0;
    double arm_solver_hold_close_qd_joint_7 = 0.0;
    double arm_solver_hold_close_qdd_joint_1 = 0.0;
    double arm_solver_hold_close_qdd_joint_2 = 0.0;
    double arm_solver_hold_close_qdd_joint_3 = 0.0;
    double arm_solver_hold_close_qdd_joint_4 = 0.0;
    double arm_solver_hold_close_qdd_joint_5 = 0.0;
    double arm_solver_hold_close_qdd_joint_6 = 0.0;
    double arm_solver_hold_close_qdd_joint_7 = 0.0;
    double arm_solver_hold_close_tau_ctrl_joint_1 = 0.0;
    double arm_solver_hold_close_tau_ctrl_joint_2 = 0.0;
    double arm_solver_hold_close_tau_ctrl_joint_3 = 0.0;
    double arm_solver_hold_close_tau_ctrl_joint_4 = 0.0;
    double arm_solver_hold_close_tau_ctrl_joint_5 = 0.0;
    double arm_solver_hold_close_tau_ctrl_joint_6 = 0.0;
    double arm_solver_hold_close_tau_ctrl_joint_7 = 0.0;
    double arm_solver_hold_close_tau_msr_joint_1 = 0.0;
    double arm_solver_hold_close_tau_msr_joint_2 = 0.0;
    double arm_solver_hold_close_tau_msr_joint_3 = 0.0;
    double arm_solver_hold_close_tau_msr_joint_4 = 0.0;
    double arm_solver_hold_close_tau_msr_joint_5 = 0.0;
    double arm_solver_hold_close_tau_msr_joint_6 = 0.0;
    double arm_solver_hold_close_tau_msr_joint_7 = 0.0;
    ...
    double cmd_ctrl_close_gripper = 0.0;
    double cmd_ctrl_open_gripper = 0.0;
    ...
    double ctrl_open_hold_orientation_ang_x_decay_rate = 0.1;
    double ctrl_open_hold_orientation_ang_x_error_integral = 0.0;
    bool ctrl_open_hold_orientation_ang_x_first_sample = false;
    double ctrl_open_hold_orientation_ang_x_kd = 2.0;
    double ctrl_open_hold_orientation_ang_x_ki = 50.0;
    double ctrl_open_hold_orientation_ang_x_kp = 250.0;
    double ctrl_open_hold_orientation_ang_x_previous_error = 0.0;
    double ctrl_open_hold_orientation_ang_y_decay_rate = 0.1;
    double ctrl_open_hold_orientation_ang_y_error_integral = 0.0;
    bool ctrl_open_hold_orientation_ang_y_first_sample = false;
    double ctrl_open_hold_orientation_ang_y_kd = 2.0;
    double ctrl_open_hold_orientation_ang_y_ki = 50.0;
    double ctrl_open_hold_orientation_ang_y_kp = 250.0;
    double ctrl_open_hold_orientation_ang_y_previous_error = 0.0;
    double ctrl_open_hold_orientation_ang_z_decay_rate = 0.1;
    double ctrl_open_hold_orientation_ang_z_error_integral = 0.0;
    bool ctrl_open_hold_orientation_ang_z_first_sample = false;
    double ctrl_open_hold_orientation_ang_z_kd = 2.0;
    double ctrl_open_hold_orientation_ang_z_ki = 50.0;
    double ctrl_open_hold_orientation_ang_z_kp = 250.0;
    double ctrl_open_hold_orientation_ang_z_previous_error = 0.0;
    double ctrl_open_hold_orientation_err_ang_x = 0.0;
    double ctrl_open_hold_orientation_err_ang_y = 0.0;
    double ctrl_open_hold_orientation_err_ang_z = 0.0;
    double ctrl_open_hold_position_err_lin_x = 0.0;
    double ctrl_open_hold_position_err_lin_y = 0.0;
    double ctrl_open_hold_position_err_lin_z = 0.0;
    double ctrl_open_hold_position_lin_x_decay_rate = 0.1;
    double ctrl_open_hold_position_lin_x_error_integral = 0.0;
    bool ctrl_open_hold_position_lin_x_first_sample = false;
    double ctrl_open_hold_position_lin_x_kd = 2.0;
    double ctrl_open_hold_position_lin_x_ki = 50.0;
    double ctrl_open_hold_position_lin_x_kp = 550.0;
    double ctrl_open_hold_position_lin_x_previous_error = 0.0;
    double ctrl_open_hold_position_lin_y_decay_rate = 0.1;
    double ctrl_open_hold_position_lin_y_error_integral = 0.0;
    bool ctrl_open_hold_position_lin_y_first_sample = false;
    double ctrl_open_hold_position_lin_y_kd = 2.0;
    double ctrl_open_hold_position_lin_y_ki = 50.0;
    double ctrl_open_hold_position_lin_y_kp = 550.0;
    double ctrl_open_hold_position_lin_y_previous_error = 0.0;
    double ctrl_open_hold_position_lin_z_decay_rate = 0.1;
    double ctrl_open_hold_position_lin_z_error_integral = 0.0;
    bool ctrl_open_hold_position_lin_z_first_sample = false;
    double ctrl_open_hold_position_lin_z_kd = 2.0;
    double ctrl_open_hold_position_lin_z_ki = 50.0;
    double ctrl_open_hold_position_lin_z_kp = 550.0;
    double ctrl_open_hold_position_lin_z_previous_error = 0.0;
    ...
    double eacc_ctrl_open_hold_orientation_ang_x = 0.0;
    double eacc_ctrl_open_hold_orientation_ang_y = 0.0;
    double eacc_ctrl_open_hold_orientation_ang_z = 0.0;
    double eacc_ctrl_open_hold_position_lin_x = 0.0;
    double eacc_ctrl_open_hold_position_lin_y = 0.0;
    double eacc_ctrl_open_hold_position_lin_z = 0.0;
    double eval_hold_close_until_closed_err = 0.0;
    double eval_hold_open_until_opened_err = 0.0;
    ...
    double gripper_pos_err_hold_close = 0.0;
    double gripper_pos_err_hold_open = 0.0;
    ...
    double mon_closed_debounce = 0.3;
    double mon_opened_debounce = 0.3;
    ...
    KDL::Twist pose_diff_ctrl_open_hold_orientation;
    KDL::Twist pose_diff_ctrl_open_hold_position;
