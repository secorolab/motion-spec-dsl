 ...
 * FSM Description: Hold the pose the arm started in while the gripper cycles.
 *
 * -----------------------------------------------------
 * Usage example:
 * -----------------------------------------------------
...
static constexpr const char * STATE_URIS[NUM_STATES] = {
    ...
    "https://secorolab.github.io/models/real-demo-hold/fsm/S_CLOSE",
    "https://secorolab.github.io/models/real-demo-hold/fsm/S_OPEN",
...
static constexpr const char * EVENT_URIS[NUM_EVENTS] = {
    ...
    "https://secorolab.github.io/models/real-demo-hold/fsm/E_GRIPPER_CLOSED",
    "https://secorolab.github.io/models/real-demo-hold/fsm/E_GRIPPER_OPENED",
};
...
static constexpr const char * TRANSITION_URIS[NUM_TRANSITIONS] = {
    "https://secorolab.github.io/models/real-demo-hold/fsm/T_START_CLOSE",
    "https://secorolab.github.io/models/real-demo-hold/fsm/T_CLOSE_OPEN",
    "https://secorolab.github.io/models/real-demo-hold/fsm/T_OPEN_CLOSE",
};
...
static constexpr const char * REACTION_URIS[NUM_REACTIONS] = {
    ...
    "https://secorolab.github.io/models/real-demo-hold/fsm/R_GRIPPER_CLOSED",
    "https://secorolab.github.io/models/real-demo-hold/fsm/R_GRIPPER_OPENED",
};
...
inline struct fsm_nbx * create_fsm() {
    ...
    struct transition * transitions = new (std::nothrow) transition[NUM_TRANSITIONS]{
        {
            .startStateIndex = S_START,
            .endStateIndex   = S_CLOSE,
        },
        {
            .startStateIndex = S_CLOSE,
    ...
    struct event_reaction * reactions = new (std::nothrow) event_reaction[NUM_REACTIONS]{
        {
            ...
            .transitionIndex     = T_START_CLOSE,
            .numFiredEvents      = 0,
            .firedEventIndices   = nullptr,
        },
        {
            .conditionEventIndex = E_GRIPPER_CLOSED,
            .transitionIndex     = T_CLOSE_OPEN,
            .numFiredEvents      = 0,
            .firedEventIndices   = nullptr,
        },
        {
            .conditionEventIndex = E_GRIPPER_OPENED,
            .transitionIndex     = T_OPEN_CLOSE,
            .numFiredEvents      = 0,
            .firedEventIndices   = nullptr,
        }};
